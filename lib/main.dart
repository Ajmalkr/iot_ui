                         ...
                         children: [
                           ...
                           Padding(
                             ...
                             child: Text(
                               "Our Product",
                               style:
                               TextStyle(fontFamily: "Mon-SemiBold", fontSize: textRatio*18),
                             ),
                           ),
                           Padding(
                             padding: const EdgeInsets.all(8.0),
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Image.asset("assets/half-moon.png",color: Colors.white,scale: 2.5,),
                                SizedBox(width: width*0.02,),
                                Text(
                                  "cold",
                                  style: TextStyle(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Image.asset("assets/clouds-and-sun.png",color: Colors.white,scale: 2.5,),
                                SizedBox(width: width*0.02,),
                                Text(
                                  "warm",
                                  style: TextStyle(
